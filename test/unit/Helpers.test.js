...
const {
  ...
  GenericHelper: { generateId, calcPages, validateInput, convertCase }
} = helpers;
...
describe('Basic Utility Functions', () => {
  ...
  it('should convert word to lower case', () => {
    const lowerCase = convertCase('TEST');
    expect(lowerCase).to.equal('test');
  });
});
