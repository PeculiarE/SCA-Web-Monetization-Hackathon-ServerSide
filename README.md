...
Create a `.env` file and add the environment variables described in the [.env.sample file](https://github.com/PeculiarE/school_web_monetization_backend/blob/main/.env.sample).
